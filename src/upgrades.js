export const UPGRADES = [
 ...
 {id:'dreamNet',name:'Dream Net',description:'Unlock Madness and +1.6 Madness/sec per level, plus more from lifetime Depth.',category:'Madness',costType:'depth',baseCost:5000,costScaling:2.4,maxLevel:8,unlock:s=>s.stage>=7&&s.resources.depth>=1000},
